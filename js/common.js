$(document).ready(function(){
	...
	var catalog = {
		...
		watch:[ 
		{
			...
			material: 'дерево',
			size: '50х41',
			dopInfo: 'Диаметр циферблата - 30 см. Возможен любой цвет и размер.',
			cost : '2 600'
		},

		{
			...
			material: 'дерево',
			size: '50',
			dopInfo: 'Диаметр циферблата - 50 см. Возможен любой цвет, размер и слова.',
			cost : '5 260'
		},

		{
			...
			material: 'дерево',
			size: '45',
			dopInfo: 'Возможен любой цвет и размер.',
			cost : '3 530'
		},
